  ...
  return (
    <div className={`bg-secondary bg-opacity-95 shadow-lg px-[8rem] py-4 flex justify-center m-auto items-center ${className} `}>
        ...
        <div className="menu flex flex-row gap-10 w-[75%] justify-end items-center">
            <div className="text-white text-[1rem] ">Home</div>
            ...
            <div className="text-white text-[1rem] "><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg></div>
        </div>
    </div>
  )
}
